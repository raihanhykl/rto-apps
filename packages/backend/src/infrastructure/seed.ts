...
const CUSTOMER_DATA = [
  {
    ...
    ktpNumber: '3174012305900001',
    birthDate: '1990-05-23',
    gender: Gender.MALE,
    rideHailingApps: ['Grab', 'Gojek'],
    guarantorName: 'Joko Santoso',
    guarantorPhone: '08129876543',
  },
  {
    ...
    ktpNumber: '3174024506880002',
    birthDate: '1988-06-45',
    gender: Gender.FEMALE,
    rideHailingApps: ['Gojek', 'Maxim'],
    guarantorName: 'Ahmad Rahmawati',
    guarantorPhone: '08561234567',
  },
  {
    ...
    ktpNumber: '3174031207950003',
    birthDate: '1995-07-12',
    gender: Gender.MALE,
    rideHailingApps: ['Grab', 'Shopee'],
    guarantorName: 'Fatimah Hidayat',
    guarantorPhone: '08191234567',
  },
  {
    fullName: 'Dewi Lestari',
    phone: '08211234567',
    email: 'dewi.lestari@outlook.com',
    address: 'Jl. Ampera Raya No. 33, Jakarta Selatan',
    ktpNumber: '3174044408920004',
    birthDate: '1992-08-04',
    gender: Gender.FEMALE,
    rideHailingApps: ['Grab', 'Gojek', 'Indrive'],
    guarantorName: 'Bambang Lestari',
    guarantorPhone: '08219876543',
  },
  {
    fullName: 'Rizky Pratama',
    phone: '08534567890',
    email: 'rizky.p@gmail.com',
    address: 'Jl. Casablanca No. 100, Jakarta Selatan',
    ktpNumber: '3174050903970005',
    birthDate: '1997-03-09',
    gender: Gender.MALE,
    rideHailingApps: ['Maxim', 'Indrive'],
    guarantorName: 'Sari Pratama',
    guarantorPhone: '08539876543',
  },
  {
    fullName: 'Nur Fadilah',
    phone: '08157890123',
    email: 'nur.fadilah@gmail.com',
    address: 'Jl. Tebet Raya No. 55, Jakarta Selatan',
    ktpNumber: '3174061511940006',
    birthDate: '1994-11-15',
    gender: Gender.FEMALE,
    rideHailingApps: ['Gojek'],
    guarantorName: 'Hasan Fadilah',
    guarantorPhone: '08151234567',
  },
  {
    fullName: 'Hendra Wijaya',
    phone: '08789012345',
    email: 'hendra.w@yahoo.com',
    address: 'Jl. Pramuka No. 22, Jakarta Timur',
    ktpNumber: '3174072008910007',
    birthDate: '1991-08-20',
    gender: Gender.MALE,
    rideHailingApps: ['Grab', 'Gojek', 'Shopee'],
    guarantorName: 'Linda Wijaya',
    guarantorPhone: '08781234567',
  },
  {
    ...
    ktpNumber: '3174081703890008',
    birthDate: '1989-03-17',
    gender: Gender.FEMALE,
    rideHailingApps: ['Grab', 'Maxim'],
    guarantorName: 'Agus Marlina',
    guarantorPhone: '08341234567',
  },
];
...
function isLiburBayar(date: Date, scheme: HolidayScheme): boolean {
  ...
  if (scheme === HolidayScheme.OLD_CONTRACT) {
    const wibDate = new Date(
      ...(wibStr.split('-').map((v, i) => (i === 1 ? Number(v) - 1 : Number(v))) as [
        number,
        number,
        number,
      ]),
...
function countCalendarDays(
  billingStart: Date,
  workingDays: number,
  scheme: HolidayScheme = DEFAULT_HOLIDAY_SCHEME,
) {
...
export async function seedDummyData(
  ...
  const contractScenarios: Array<{
    ...
    {
      customerIdx: 0,
      motor: MotorModel.ATHENA,
      battery: BatteryType.REGULAR,
    ...
    {
      customerIdx: 1,
      motor: MotorModel.VICTORY,
      battery: BatteryType.EXTENDED,
      dpScheme: DPScheme.INSTALLMENT,
      startDaysAgo: 10,
      status: ContractStatus.ACTIVE,
      dpPaid: true,
      unitReceived: true,
  ...
  for (let i = 0; i < contractScenarios.length; i++) {
    ...
    const progress = parseFloat(
      ((actualTotalDaysPaid / DEFAULT_OWNERSHIP_TARGET_DAYS) * 100).toFixed(2),
    );
    ...
    const contract: Contract = {
      ...
      dpPaidAmount: scenario.dpPaid
        ? dpAmount
        : scenario.dpScheme === DPScheme.INSTALLMENT
          ? Math.ceil(dpAmount / 2)
          : 0,
    ...
    if (scenario.dpScheme === DPScheme.FULL) {
      ...
      const dpInvoice: Invoice = {
        ...
        lateFee: 0,
        type: InvoiceType.DP,
        status: scenario.dpPaid
          ? PaymentStatus.PAID
          : scenario.status === ContractStatus.REPOSSESSED
            ? PaymentStatus.VOID
